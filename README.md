...
상세 구조는 [architecture.md](/Users/julirsia/development/company/openwebui-bot/docs/architecture.md)에 분리했습니다.

짧게 요약하면:

- Open WebUI가 사용자 포털, 채널 UI, 모델 preset, native tools, terminal connection을 관리합니다.
- `owbot` 워커는 채널 멘션을 받아 문맥을 수집하고 completion을 실행한 뒤 응답을 다시 게시합니다.
- OpenTerminal은 별도 API 서버이며, 워커가 직접 붙는 것이 아니라 Open WebUI가 terminal connection `url`을 통해 호출합니다.
...
- [runbook.md](/Users/julirsia/development/company/openwebui-bot/docs/runbook.md)
  ...
  - 운영 배포 전 검증 순서
- [architecture.md](/Users/julirsia/development/company/openwebui-bot/docs/architecture.md)
  - 시스템 구성 요소
  - 요청 흐름
  - OpenTerminal 연결 구조
  - skill 구조와 배포 토폴로지 예시
...
- [prompts/terminal-bot-system-prompt.txt](/Users/julirsia/development/company/openwebui-bot/prompts/terminal-bot-system-prompt.txt)
- [prompts/rag-mcp-bot-system-prompt.txt](/Users/julirsia/development/company/openwebui-bot/prompts/rag-mcp-bot-system-prompt.txt)
- [prompts/plane-mcp-bot-system-prompt.txt](/Users/julirsia/development/company/openwebui-bot/prompts/plane-mcp-bot-system-prompt.txt)
